...
class M_Eticket extends CI_Model
{
    ...
    public function get_sumJul()
    {
        ...
        $this->db->from("transaksi where tgl <= '2022-07-32' and tgl >= '2022-07-01'");
    ...
    {
        $this->db->select_sum('total');
        $this->db->from("transaksi where tgl <= '2022-08-32' and tgl >= '2022-08-01'");
        return $this->db->get('')->row();
    }
    ...
    {
        $this->db->select_sum('total');
        $this->db->from("transaksi where tgl <= '2022-09-31' and tgl >= '2022-09-01'");
        return $this->db->get('')->row();
    }
    ...
    {
        $this->db->select_sum('total');
        $this->db->from("transaksi where tgl <= '2022-10-32' and tgl >= '2022-10-01'");
        return $this->db->get('')->row();
    }
    ...
    {
        $this->db->select_sum('total');
        $this->db->from("transaksi where tgl <= '2022-11-31' and tgl >= '2022-11-01'");
        return $this->db->get('')->row();
    }
    ...
    {
        $this->db->select_sum('total');
        $this->db->from("transaksi where tgl <= '2022-12-32' and tgl >= '2022-12-01'");
        return $this->db->get('')->row();
    }
    ...
    {
        $this->db->select_sum('total');
        $this->db->from("transaksi where tgl <= '2023-01-32' and tgl >= '2023-01-01'");
        return $this->db->get('')->row();
    }
    ...
    {
        $this->db->select_sum('total');
        $this->db->from("transaksi where tgl <= '2023-02-29' and tgl >= '2023-02-01'");
        return $this->db->get('')->row();
    }
    ...
    {
        $this->db->select_sum('total');
        $this->db->from("transaksi where tgl <= '2023-03-32' and tgl >= '2023-03-01'");
        return $this->db->get('')->row();
    }
    ...
    {
        $this->db->select_sum('total');
        $this->db->from("transaksi where tgl <= '2023-04-31' and tgl >= '2023-04-01'");
        return $this->db->get('')->row();
    }
    ...
    {
        $this->db->select_sum('total');
        $this->db->from("transaksi where tgl <= '2023-05-32' and tgl >= '2023-05-01'");
        return $this->db->get('')->row();
    }
    ...
    {
        $this->db->select_sum('total');
        $this->db->from("transaksi where tgl <= '2023-06-31' and tgl >= '2023-06-01'");
        return $this->db->get('')->row();
    }
