							...
							<div class="row">
								<div class="col-lg-12">
									<div class="all-form-element-inner">
										<form method="post" action="<?= base_url(''); ?>/Pembayaran/aksi_tambah" method="POST">
											<h3>
												...
												<div class="row">
													...
													<div class="col-lg-9">
														<div class="form-select-list">
															<input type="text" name='id' value="<?=rand(10, 10000); ?>" class="form-control" readonly required="">
														</div>
													</div>
												</div>
											</div>
												...
												<div class="row">
													<div class="col-lg-3">
														<label class="login2 pull-right pull-right-pro">Jumlah
															Tanggungan / Jiwa</label>
													</div>
													<div class="col-lg-9">
														<div class="form-select-list">
															<input type="text" name="jumlah_jiwa" class="form-control" placeholder="Jumlah anggota keluarga yang dibayarkan" required="">
														</div>
													</div>
												</div>
											</div>
											...
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-9">
														<div class="form-select-list">
															<input type="text" name="pembayar1" class="form-control" placeholder="nama pembayar zakat" required="">
														</div>
													</div>
												</div>
											</div>
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-9">
														<div class="form-select-list">
															<input type="text" name="pembayar2" class="form-control" placeholder="nama pembayar zakat" value="-">
														</div>
													</div>
												</div>
											</div>
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-9">
														<div class="form-select-list">
															<input type="text" name="pembayar3" class="form-control" placeholder="nama pembayar zakat" value="-">
														</div>
													</div>
												</div>
											</div>
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-9">
														<div class="form-select-list">
															<input type="text" name="pembayar4" class="form-control" placeholder="nama pembayar zakat" value="-">
														</div>
													</div>
												</div>
											</div>
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-9">
														<div class="form-select-list">
															<input type="text" name="pembayar5" class="form-control" placeholder="nama pembayar zakat" value="-">
														</div>
													</div>
												</div>
											</div>
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-9">
														<div class="form-select-list">
															<input type="text" name="pembayar6" class="form-control" placeholder="nama pembayar zakat" value="-">
														</div>
													</div>
												</div>
											</div>
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-9">
														<div class="form-select-list">
															<input type="text" name="pembayar7" class="form-control" placeholder="nama pembayar zakat" value="-">
														</div>
													</div>
												</div>
											</div>
												...
												<div class="row">
													...
													<div class="col-lg-9">
														<div class="form-select-list">
															...
															<input type="text" name="beras" class="form-control" placeholder="total besar beras Kg" value="0" required>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-9">
														<div class="form-select-list">
															<input type="text" name="uang" class="form-control" id="txt2" onkeyup="sum();" placeholder="Total yang harus dibayarkan. Contoh: 48000" value="0" required>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-9">
														<div class="form-select-list">
															<input type="text" name="mal" class="form-control" id="txt2" onkeyup="sum();" placeholder="Total yang harus dibayarkan. Contoh: 48000" value="0" required>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-9">
														<div class="form-select-list">
															<input type="text" name="fidyah" class="form-control" id="txt2" onkeyup="sum();" placeholder="Total yang harus dibayarkan. Contoh: 48000" value="0" required>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="form-group-inner">
												<div class="row">
													<div class="col-lg-3">
														<label class="login2 pull-right pull-right-pro">Shadaqah/Infaq</label>
													</div>
													<div class="col-lg-9">
														<div class="form-select-list">
															<input type="text" name="infaq" class="form-control" id="txt2" onkeyup="sum();" placeholder="Total yang harus dibayarkan. Contoh: 48000" value="0" required>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-9">
														<div class="form-select-list">
															<input type="text" name="penerima" class="form-control" id="txt2" onkeyup="sum();" placeholder="Nama panitia zakat" required>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="form-group-inner">
												<div class="row">
													...
													<div class="col-lg-9">
														<div class="form-select-list">
															<input type="text" name='status' value="Belum Validasi" class="form-control" readonly required="">
														</div>
													</div>
												</div>
											</div>
