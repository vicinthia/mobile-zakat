						...
						<div class="row">
							...
							<div class="col-lg-6">
								<ul class="breadcome-menu">
									...
									<li><span class="bread-blod">Rekapitulasi Zakat Beras</span>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="sparkline13-list shadow-reset">
						<div class="sparkline13-hd">
							<div class="main-sparkline13-hd">
								<h1>Detail Penerimaan Beras Zakat</h1>
							</div>
						</div>
						...
						<div class="sparkline13-graph">
                                ...
                                <p align= "left" class="totalU">
									Jumlah Total : <?= ($sum_totalAllAprMeiBeras->beras) ?> Kg
								</p>
							</div>
						</div>
					</div>
