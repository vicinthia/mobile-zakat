						...
						<div class="row">
							...
							<div class="col-lg-6">
								<ul class="breadcome-menu">
									...
									<li><span class="bread-blod">Rekapitulasi Shadaqah/Infaq</span>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="sparkline13-list shadow-reset">
						<div class="sparkline13-hd">
							<div class="main-sparkline13-hd">
								<h1>Detail Penerimaan Shadaqah/Infaq</h1>
							</div>
						</div>
						...
						<div class="sparkline13-graph">
								...
								<p align= "left" class="totalU">
									Jumlah Total : Rp.<?php echo number_format($sum_totalAllAprMeiInfaq->infaq) ?>
								</p>
							</div>
						</div>
					</div>
