...
<head>
    <title>Penerimaan Uang Zakat</title>
    <style>
        .judul {
            font-weight: bold;
            font-size: large;
...
<body>
    ...
    <table align="center">
        <tr>
            <td align="center">
                <p class="judul">REKAPITULASI JUMLAH PENERIMAAN DANA ZAKAT</p>
    ...
    <table border="1" cellspacing="0" align="center">
        ...
        <tr>
            ...
            <td width="300" align="right"><?php echo number_format($sum_totalApr1->uang) ?></td>
        </tr>
        <tr>
            <td width="50">2</td>
            <td width="300">Minggu, 02-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr2->uang) ?></td>
        </tr>
        <tr>
            <td width="50">3</td>
            <td width="300">Senin, 03-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr3->uang) ?></td>
        </tr>
        <tr>
            <td width="50">4</td>
            <td width="300">Selasa, 04-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr4->uang) ?></td>
        </tr>
        <tr>
            <td width="50">5</td>
            <td width="300">Rabu, 05-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr5->uang) ?></td>
        </tr>
        <tr>
            <td width="50">6</td>
            <td width="300">Kamis, 06-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr6->uang) ?></td>
        </tr>
        <tr>
            <td width="50">7</td>
            <td width="300">Jumat, 07-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr7->uang) ?></td>
        </tr>
        <tr>
            <td width="50">8</td>
            <td width="300">Sabtu, 08-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr8->uang) ?></td>
        </tr>
        <tr>
            <td width="50">9</td>
            <td width="300">Minggu, 09-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr9->uang) ?></td>
        </tr>
        <tr>
            <td width="50">10</td>
            <td width="300">Senin, 10-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr10->uang) ?></td>
        </tr>
        <tr>
            <td width="50">11</td>
            <td width="300">Selasa, 11-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr11->uang) ?></td>
        </tr>
        <tr>
            <td width="50">12</td>
            <td width="300">Rabu, 12-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr12->uang) ?></td>
        </tr>
        <tr>
            <td width="50">13</td>
            <td width="300">Kamis, 13-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr13->uang) ?></td>
        </tr>
        <tr>
            <td width="50">14</td>
            <td width="300">Jumat, 14-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr14->uang) ?></td>
        </tr>
        <tr>
            <td width="50">15</td>
            <td width="300">Sabtu, 15-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr15->uang) ?></td>
        </tr>
        <tr>
            <td width="50">16</td>
            <td width="300">Minggu, 16-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr16->uang) ?></td>
        </tr>
        <tr>
            <td width="50">17</td>
            <td width="300">Senin, 17-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr17->uang) ?></td>
        </tr>
        <tr>
            <td width="50">18</td>
            <td width="300">Selasa, 18-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr18->uang) ?></td>
        </tr>
        <tr>
            <td width="50">19</td>
            <td width="300">Rabu, 19-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr19->uang) ?></td>
        </tr>
        <tr>
            <td width="50">20</td>
            <td width="300">Kamis, 20-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr20->uang) ?></td>
        </tr>
        <tr>
            <td width="50">21</td>
            <td width="300">Jumat, 21-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr21->uang) ?></td>
        </tr>
        <tr>
            <td width="50">22</td>
            <td width="300">Sabtu, 22-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr22->uang) ?></td>
        </tr>
        <tr>
            <td width="50">23</td>
            <td width="300">Minggu, 23-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr23->uang) ?></td>
        </tr>
        <tr>
            <td width="50">24</td>
            <td width="300">Senin, 24-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr24->uang) ?></td>
        </tr>
        <tr>
            <td width="50">25</td>
            <td width="300">Selasa, 25-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr25->uang) ?></td>
        </tr>
        <tr>
            <td width="50">26</td>
            <td width="300">Rabu, 26-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr26->uang) ?></td>
        </tr>
        <tr>
            <td width="50">27</td>
            <td width="300">Kamis, 27-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr27->uang) ?></td>
        </tr>
        <tr>
            <td width="50">28</td>
            <td width="300">Jumat, 28-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr28->uang) ?></td>
        </tr>
        <tr>
            <td width="50">29</td>
            <td width="300">Sabtu, 29-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr29->uang) ?></td>
        </tr>
        <tr>
            <td width="50">30</td>
            <td width="300">Minggu, 30-04-2023</td>
            <td width="300" align="right"><?php echo number_format($sum_totalApr30->uang) ?></td>
        </tr>

        <tr style="font-weight: bold;">
            <td colspan="2" align="center">Jumlah Total :</td>
            <td width="300" align="right">Rp.<?php echo number_format($sum_totalAllApr->uang) ?></td>
        </tr>
