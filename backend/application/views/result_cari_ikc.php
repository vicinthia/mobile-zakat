...
<body>
    <div class="col-lg-12">
        <h1 class="page-header">Daftar Transaksi (Akses : IKC)</h1>
    </div>
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="dataTable_wrapper">
                        <div class="container">
                            <table class="table table-bordered table-striped table-hover" id="dataTables-example">
                                ...
                                <form action="<?php echo base_url('home/hasilIKC') ?>" action="GET">
                                ...
                                <a href="<?= base_url('home/halaman_transaksi_admin') ?>"><button class="btn btn-primary">Kembali</button>
                                </a>
                                ...
                                ?>
                                        ...
                                        <td><a href="<?php echo base_url('home/delete') ?>/<?php echo $row->id_transaksi ?>">Delete</a></td>
                                        </tr>
                                    <?php } ?>
                                <?php
                                    $no++;
