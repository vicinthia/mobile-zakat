...
//void main() => runApp(PrintFidyah());

class PrintFidyah extends StatefulWidget {
  final kode_zakat;
  final nama_muz;
  final alamat_muz;
  final nama_amil;
  ...
  @override
  State<PrintFidyah> createState() => _PrintFidyahState();
}

class _PrintFidyahState extends State<PrintFidyah> {
              ...
              return ListTile(
                ...
                onTap: () async {
                  ...
                  if ((await printer.isConnected)) {
                    ...
                    printer.printCustom(
                        '--------------------------------', 1, 1);
                    printer.printCustom('Berupa (Keterangan)', 1, 0);

                    printer.printLeftRight(
                      'Tidak Puasa : ',
                      '${widget.hari_fidyah} Hari',
                      1,
                    );
                    printer.printCustom('Besaran Fidyah/Hari :', 1, 0);
                    printer.printCustom(
                        '${CurrencyFormat.convertToIdr(widget.nominal_fidyah, 0)}',
                        1,
                        0);
                    printer.printLeftRight(
                      'Total Fidyah : ',
                      '${widget.hari_fidyah} x ${CurrencyFormat.convertToIdr(widget.nominal_fidyah, 0)}',
                      1,
                    );
