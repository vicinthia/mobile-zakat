...
//void main() => runApp(PrintMaal());

class PrintMaal extends StatefulWidget {
  final kode_zakat;
  final nama_muz;
  final alamat_muz;
  final nama_amil;
  ...
  @override
  State<PrintMaal> createState() => _PrintMaalState();
}

class _PrintMaalState extends State<PrintMaal> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            ...
            title: Text('Print Bukti Zakat Maal'),
            leading: IconButton(
