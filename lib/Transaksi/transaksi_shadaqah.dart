...
import '../printTransaksi/printShadaqah.dart';

class transaksiShadaqah extends StatefulWidget {
  @override
  State<transaksiShadaqah> createState() => _transaksiShadaqahState();
}

class _transaksiShadaqahState extends State<transaksiShadaqah> {
  ...
  String _selectedPembayaran = ''; // Track selected nominal value
  ...
  // void addkategoriZakat() {
  //   var url = http.post(
  //       Uri.parse(
  //           "http://192.168.3.233/api/zakat/transaksizakat"),
  //       body: {
  //         "kode_zakat": "Zkt-000${_transactionId + 1}",
  //         "kode_muzakki": kodeMuz,
  //         "total_zakat":
  //             "${_nominalController.text.replaceAll('Rp', '').replaceAll('.', '')}",
  //         "kode_amil": kodeAmil,
  //         "tgl_zakat": "$tgl_transaksi",
  //         "kode_kategori": "Zakat Maal"
  //       });
  // }
  ...
  Future<void> getImage() async {
    ...
    if (getimage != null) {
      ...
      if (image != null) {
        ...
        imagename =
            'Zkt-${pluslastId}__${kodeMuz + alamat}_qrisShadaqah.${getimage.path.split('.').last}';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Text('Masukkan Nominal Shadaqah'),
          SizedBox(height: 8),
          TextField(
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              await CoolAlert.show(
                ...
                title: "Transaksi Shadaqah",
                text: "Berhasil dishadaqahkan!",
                confirmBtnText: "Ok",
