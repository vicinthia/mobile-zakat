...
class TransaksiBagiFitrah extends StatefulWidget {
  @override
  State<TransaksiBagiFitrah> createState() => _TransaksiBagiFitrahState();
}

class _TransaksiBagiFitrahState extends State<TransaksiBagiFitrah> {
  ...
  String kodeBagi; // Variabel global
  ...
  //       "data": imagedata,
  //       "name": imagename,
  //       "kode_bagi": "F-000${_transactionId + 1}",
  //     });
  ...
  //     imagename = '${namaMus}_FitrahMustahik.$fileExtension';
  ...
  Future<void> getImage() async {
    ...
    if (getimage != null) {
      ...
      if (image != null) {
        ...
        imagename =
            'F-${pluslastId}__${namaMus}_FitrahMustahik.${getimage.path.split('.').last}';
      ...
      body: ListView(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Flexible(
                child: Text('Total Bagi Zakat Fitrah(Beras)',
                    style:
          ...
          ElevatedButton(
            onPressed: () async {
              if (addDataZakat == null) {
                ...
                if (_kiloController.text != "0" && _kiloController.text != "") {
                  await testGetLast;
                  await addDataZakat();
                  KirimGambar();
