...
class SelectRiwayatPage extends StatefulWidget {
  final kategoriZakat;

  SelectRiwayatPage({this.kategoriZakat});
  @override
  State<SelectRiwayatPage> createState() => _SelectRiwayatPageState();
}

class _SelectRiwayatPageState extends State<SelectRiwayatPage> {
  ...
  Future<List> selectData() async {
    final response = await http.get(Uri.parse(ApiConstants.baseUrl +
        "api/zakat/riwayatzakat?kode_kategori=${widget.kategoriZakat}"));
    return json.decode(response.body)['data'];
  }
