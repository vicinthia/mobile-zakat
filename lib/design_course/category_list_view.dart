import 'package:zakat_mobile/design_course/design_course_app_theme.dart';
...
class _CategoryListViewState extends State<CategoryListView>
  ...
  final Map<String, String> _routeMap = {
    ...
    'AgendaMasjid': '/agendamasjid',
    'BidangMasjid': '/bidangmasjid',
    'KontakMasjid': '/kontakmasjid',
  };
            ...
            if (!snapshot.hasData) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  final route =
                      _routeMap[category.title] ?? '/'; // Default route
