...
class SelectMustahikPage extends StatefulWidget {
  final selectAsnaf;
  SelectMustahikPage({this.selectAsnaf});

  @override
  State<SelectMustahikPage> createState() => _SelectMustahikPageState();
}

class _SelectMustahikPageState extends State<SelectMustahikPage> {
  String Harga;
  ...
  Future<List> getData() async {
    final response = await http.get(Uri.parse(ApiConstants.baseUrl +
        "api/zakat/mustahik?ket_mustahik=${widget.selectAsnaf}"));
